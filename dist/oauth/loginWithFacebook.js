      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            _result$data$loginWit = result.data.loginWithFacebook, id = _result$data$loginWit.id, token = _result$data$loginWit.token, tokenExpires = _result$data$loginWit.tokenExpires;
            _context.next = 6;
